...
func WordsVotePage(id, question string, redo bool, csrfToken string) g.Node {
...
func MultipleChoiceVotePage(id, question string, options []models.Option, csrfToken string) g.Node {
	return components.Page(
		"Vote",
		false,
		Div(Class("flex flex-col min-h-[calc(100dvh-10rem)] justify-center items-center space-y-4"),
